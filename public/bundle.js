...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsUpdate = __webpack_require__(161);
	...
	var Content = function (_React$Component) {
	  ...
	  function Content(props) {
	    ...
	    _this.state = { counter: 0, numberArray: [] };
	    return _this;
	  }
	  ...
	  _createClass(Content, [{
	    ...
	    key: 'updateNumberArray',
	    value: function updateNumberArray() {
	      $.get('test_array', function (result) {
	        console.log(result);
	        this.setState({
	          numberArray: (0, _reactAddonsUpdate2.default)(this.state.numberArray, { '$set': result.data })
	        });
	      }.bind(this), "json");
	    }
	  }, {
